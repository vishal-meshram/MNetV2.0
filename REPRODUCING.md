...
`registry.codeocean.com/published/1c025436-ac95-4cca-81fd-fb73e53f27c8:v1`
...
docker run --platform linux/amd64 --rm --gpus all \
  ...
  registry.codeocean.com/published/1c025436-ac95-4cca-81fd-fb73e53f27c8:v1 bash run
```
